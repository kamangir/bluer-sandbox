...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/docs/bluer-README), based on 🌀 [`bluer_sandbox-5.648.1`](https://github.com/kamangir/bluer-sandbox).

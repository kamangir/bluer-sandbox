...
|   |   |
| --- | --- |
| [`v2ray`](./bluer_sandbox/docs/v2ray.md) [![image](https://github.com/kamangir/assets2/raw/main/v2ray/v2ray.png?raw=true)](./bluer_sandbox/docs/v2ray.md) tools to work with [v2ray](hhttps://en.wikipedia.org/wiki/V2Ray). | [`arvancloud`](./bluer_sandbox/docs/arvancloud.md) [![image](https://github.com/kamangir/assets/raw/main/arvancloud/arvancloud.png?raw=true)](./bluer_sandbox/docs/arvancloud.md) tools to work with [arvancloud](https://arvancloud.ir/). |
...
| [`bluer village`](./bluer_sandbox/docs/aliases/village.md) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](./bluer_sandbox/docs/aliases/village.md) a bluer village. |  |
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 🌀 [`bluer_sandbox-5.523.1`](https://github.com/kamangir/bluer-sandbox).
